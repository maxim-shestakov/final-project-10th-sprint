...
#   dir3
#       dir4
mkdir task task/dir2 task/dir3 task/dir3/dir4 task/dir1
...
dir2/hello.sh "$NAME" >> dir1/summary.txt #двойные кавычки в NAME для того, чтобы переменная принималась единым аргументом

# перемещаем с переименованием task/dir1/summary.txt в task/Практическое задание
mv  dir1/summary.txt dir1/'Практическое задание'
mv dir1/'Практическое задание' .
